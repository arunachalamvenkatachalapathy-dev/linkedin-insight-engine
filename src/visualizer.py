...
Calls OpenAI DALL-E 3 / Pollinations Ultra AI Engine to generate 16:9 3D Isometric Infographic Slides.
"""
...
def generate_dalle_slide(prompt_blueprint: str, out_path: str, api_key: str) -> bool:
    ...
    try:
        ...
        payload = {
            ...
            "n": 1,
            "size": "1792x1024",
            "quality": "hd"  # Enforce HD quality rendering for crisp graphics and typography
        }
...
def generate_pollinations_slide(prompt_blueprint: str, out_path: str) -> bool:
    ...
    try:
        ...
        # Enhance prompt with explicit 3D isometric & glassmorphism keywords
        enhanced_prompt = (
        ...
        # Seed parameter ensures consistent crisp generation
...
def render_3d_slide(prompt_blueprint: str, scout_data: dict, out_path: str = "state/latest_slide.png") -> str:
    ...
    # 1. Try DALL-E 3 HD if API Key present
    if openai_key:
        if generate_dalle_slide(prompt_blueprint, out_path, openai_key):
            return out_path

    # 2. Try Pollinations Enhanced Engine
